...
var OverflowList = /** @class */ (function (_super) {
    ...
    function OverflowList(props, context) {
        ...
        _this.observer = new ResizeObserver(throttle(_this.resize));
        _this.state = {
            overflow: [],
            visible: props.items,
        };
    ...
    OverflowList.prototype.componentDidMount = function () {
        if (this.element != null) {
            ...
            if (this.props.observeParents) {
                for (var element = this.element; element != null; element = element.parentElement) {
    ...
    OverflowList.prototype.componentWillReceiveProps = function (nextProps) {
        var _a = this.props, collapseFrom = _a.collapseFrom, items = _a.items, observeParents = _a.observeParents, overflowRenderer = _a.overflowRenderer, visibleItemRenderer = _a.visibleItemRenderer;
    ...
    OverflowList.prototype.render = function () {
        var _this = this;
        var _a = this.props, className = _a.className, collapseFrom = _a.collapseFrom, style = _a.style, visibleItemRenderer = _a.visibleItemRenderer;
        var overflow = this.maybeRenderOverflow();
        return (React.createElement("div", { className: classNames(Classes.OVERFLOW_LIST, className), ref: function (ref) { return (_this.element = ref); }, style: style },
    ...
    OverflowList.prototype.repartition = function (growing) {
        ...
        if (growing) {
            ...
            this.setState(function (state) {
                ...
                var overflow = collapseFromStart ? [next].concat(state.overflow) : state.overflow.concat([next]);
                return {
                    overflow: overflow,
                    visible: visible,
                };
    ...
    OverflowList.displayName = "Blueprint2.OverflowList";
